...
int main() {
    ...
    DtHuesped *pedro = new DtHuesped("pedro", "pedro@gmail.com", true);
    DtHuesped *jose = new DtHuesped("Jose", "jose@gmail.com", true);

    DtHuesped **huespedes = new DtHuesped *[3];
    huespedes[0] = pedro;
    huespedes[1] = jose;
    huespedes[2] = nullptr;
    ...
    int cont = 0;
    std::cout << cont;
    DtReserva **reservas = sistema.obtenerReservas(fecha1, cont);
    int i = 0;
    while (reservas[i] != nullptr) {
        delete reservas[i];
        i++;
    }
    delete[] reservas;
